...
const DEFAULT_SETTINGS = { version: VERSION, teamName:"Gestione_squadra", category:"", misterName:"", logoDataUrl:"" };
...
// Normalizza sempre gli id come stringhe (evita mismatch numero/stringa in selezioni, convocazioni, ecc.)
if(Array.isArray(roster)){
  roster = roster.map(p=>({ ...p, id: String(p?.id ?? "") }));
}
...
pages.convocazioni = $("page-convocazioni");
// ESERCIZI
...
function setTab(tab){
  ...
  if(tab==="convocazioni"){ initWhatsAppConvocation(); }
