...
async function enterBoardFullscreen(){
  // iOS Safari: il fullscreen nativo è instabile e provoca "campo a metà".
  // Usiamo sempre la modalità presentazione (CSS full screen) che è affidabile.
  setTool("none");
  if(isIOSBoard()){
    enterPresentMode();
    setTimeout(safeBoardResize, 120);
    setTimeout(safeBoardResize, 380);
    return;
  }
