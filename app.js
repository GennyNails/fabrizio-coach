...
function ensureFixedBoardTokens(){
  ...
  const gapY = 68;
  for(let i=0;i<6;i++){
    tokens.appendChild(createToken(red, startX, 18 + i*gapY, "red"));
  }
  // 1 gialla in basso (a sinistra, leggermente più in basso)
  tokens.appendChild(createToken(yellow, startX, 18 + 6*gapY, "yellow"));
