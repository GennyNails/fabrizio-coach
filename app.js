...
function requestBoardFullscreen(){
  const fsWrap = document.getElementById("fsWrap");
  if(!fsWrap) return;
  // Su mobile l'API fullscreen è spesso instabile/bloccata. Per evitare regressioni,
  // usiamo SEMPRE il pseudo-fullscreen (overlay fixed) che funziona su Chrome/Android e iOS.
  // Se il fullscreen nativo è disponibile e l'utente lo attiva manualmente, comunque l'overlay
  // resta compatibile con il drag e con il canvas.
